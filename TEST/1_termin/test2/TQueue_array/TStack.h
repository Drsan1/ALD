...
typedef char TStackElement;					///< Definice typu StackElement (datový typ elementů zásobníku)
#define TSTACK_ELEMENT_FRMSTR "%s"			///< Definice formátovacího řetězce pro souborové operace s typem StackElement
