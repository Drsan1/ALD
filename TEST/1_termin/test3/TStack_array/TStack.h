...
#define TSTACK_ELEMENT_FRMSTR "%d"			///< Definice formátovacího řetězce pro souborové operace s typem StackElement
...
struct TStack
	...
	TStackElement* iValues;					///< Počátek dynamicky alokovaného pole elementů
	size_t iCapacity;
	};
